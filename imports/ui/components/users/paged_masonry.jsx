...
import GalleryCard from '../cards/hero_card/nouser_board_card';
...
import NoMyBoardsNonuser from '/imports/ui/components/boards/my/empty/nonuser';
import NoMyBoards from '/imports/ui/components/boards/my/empty/empty';
...
const EmptyMessage = composeAll(
  ...
  if (routeName === 'profile') {
    return (
      <PageMessage>
        <p>
          This Maven member currently has no boards; check back later!
        </p>
      </PageMessage>
    );
  }
 ...
 */
const ProfilePagedMasonry = pagedMasonryHOC({
...
export default ProfilePagedMasonry;
